...
def main(args=None):
    ...
    extract_features_and_labels(path, features)
    extract_features(path, features)
    extract_embeddings_as_features_and_gold(path, word_embedding_model, num_features, features)
    extract_embeddings_as_features(path, word_embedding_model, num_features, features)
    ...
    #classify_data(ml_model, vec, feature_list, inputfile, 'negcue_detection_test' + '.conll')
